...
console.log(recuperoStorage);
  ...
  for (var i = 0; i < seriesFavoritas.length; i++) {
    ...
    fetch("https://api.themoviedb.org/3/tv/" + seriesFavoritas[i] + "?api_key=9901ee414425659325dc091c288e33c9&language=Es&page")
     ...
     .then(function() {
        document.querySelector(".favoritas").innerHTML += "<div class='punt'><a href=detalle.html?id="+ seriesFavoritas[i].id +"><img src=http://image.tmdb.org/t/p/w200"+ seriesFavoritas[i].poster_path +"></a><h5>" + seriesFavoritas[i].name + "</h5><h6>"+seriesFavoritas[i].vote_average+"<ion-icon name='star'></ion-icon></h6></div>"
      })
  }
}
